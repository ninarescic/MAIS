python run_multi_experiment.py -R ../config/random_seeds.txt --n_jobs 4 --n_repeat 30 ../config/demo_0.ini demo0
python run_multi_experiment.py -R ../config/random_seeds.txt --n_jobs 4 --n_repeat 30 ../config/demo_1.ini demo1
...
FILES="../data/output/model/history_demo0.zip ../data/output/model/history_demo1.zip"

python plot_experiments.py $FILES --label_names 0,1 --out_file demo_tracing.png
geeqie demo_tracing.png
